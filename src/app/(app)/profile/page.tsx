    ...
    <div className="max-w-3xl mx-auto px-4 md:px-6 py-8 md:py-10 space-y-6 md:space-y-8 w-full">
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          ...
          <div
            key={s.label}
            className="bg-zinc-900 border border-border rounded-md p-3 md:p-5 space-y-1"
          >
      ...
      {/* Clean rate */}
      <div className="bg-zinc-900 border border-border rounded-md p-4 md:p-5 space-y-3">
        <div className="flex items-center justify-between">
      ...
      {/* Activity heatmap */}
      <div className="bg-zinc-900 border border-border rounded-md p-4 md:p-5 space-y-4">
        <div className="flex items-center gap-2">
